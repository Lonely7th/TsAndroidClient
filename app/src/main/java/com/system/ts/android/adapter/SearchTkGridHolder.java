 ...
 * Version : 1.0.0 .
 */
public class SearchTkGridHolder extends YBaseHolder<SearchBean> {

    @Bind(R.id.tv_content)
    TextView tvContent;

    public SearchTkGridHolder(Context mContext, List<SearchBean> mLists) {
    ...
    public View getInflateView(Context mContext) {
        View view = View.inflate(mContext, R.layout.item_search_data_grid, null);
        return view;
    }
